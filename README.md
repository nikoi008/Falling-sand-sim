...
# About
Falling sand sim is a sandbox sand toy where you can use different materials and see how they interact with each other!

# Blocks
There are currently 4 different types of blocks
| Block name | Block function |
|-------------|---------------|
|Air/erase    |  turns a block into air Z
